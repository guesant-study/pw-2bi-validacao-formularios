...
const PwHeader = class {
  ...
  get computedBrandImageUrl() {
    var _a;
    return (_a = this.brandImageUrl) !== null && _a !== void 0 ? _a : `${this.computedBaseUrl}imgs/logo.webp`;
  }
  get computedLinkBaseUrl() {
    var _a;
    return (_a = this.linkBaseUrl) !== null && _a !== void 0 ? _a : `${this.computedBaseUrl}`;
  }
  get computedBrandHref() {
    var _a;
    return (_a = this.brandHref) !== null && _a !== void 0 ? _a : `${this.computedBaseUrl}`;
  }
  render() {
